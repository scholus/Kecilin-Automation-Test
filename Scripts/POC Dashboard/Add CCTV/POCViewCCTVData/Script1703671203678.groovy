...
String baseUrl = GlobalVariable.poc_dashboard_url

WebUI.callTestCase(findTestCase('POC Dashboard/Sign In/POCSignInValidData'), [:], failureHandling)

WebUI.navigateToUrl(baseUrl + '/cctv', failureHandling)

WebUI.navigateToUrl(baseUrl + '/cctv/create', failureHandling)

WebUI.setText(findTestObject('Object Repository/Page Add new CCTV Offline Web/input_Name_name'), 'a', failureHandling)

WebUI.setText(findTestObject('Object Repository/Page Add new CCTV Offline Web/input_CCTV ID_cctv_id'), 'a', failureHandling)
