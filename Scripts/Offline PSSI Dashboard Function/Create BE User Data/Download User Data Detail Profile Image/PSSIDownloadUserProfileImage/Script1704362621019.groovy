...
// klik download
WebUI.verifyElementClickable(findTestObject('Page_Detail User/Page_Detail User/download image profile'))

WebUI.click(findTestObject('Page_Detail User/Page_Detail User/download image profile'))

// verifikasi download window kebuka
WebUI.verifyElementNotPresent(findTestObject('Page_Detail User/button_Print Data'), 0)
