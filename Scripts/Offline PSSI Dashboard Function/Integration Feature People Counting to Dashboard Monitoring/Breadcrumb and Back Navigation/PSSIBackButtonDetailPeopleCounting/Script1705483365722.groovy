...
WebUI.verifyElementPresent(findTestObject('Page_Detail People Counting/Back Button'),1)
WebUI.verifyElementClickable(findTestObject('Page_Detail People Counting/Back Button'))
WebUI.click(findTestObject('Page_Detail People Counting/Back Button'))

//verifikasi sudah balik ke people counting page
