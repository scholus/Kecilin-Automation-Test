...
// verify pop up nya ada
WebUI.scrollToElement(findTestObject('Page_Monitoring/button_Identify Now Pop Up'), 1)
WebUI.waitForElementPresent(findTestObject('Page_Monitoring/button_Identify Now Pop Up'), 5)
WebUI.verifyElementClickable(findTestObject('Page_Monitoring/button_Identify Now Pop Up'))
WebUI.click(findTestObject('Page_Monitoring/button_Identify Now Pop Up'))

// tunggu muncul hasil result
WebUI.waitForElementPresent(findTestObject('Page_Result Monitoring/Result Monitoring Title'), 15)

// klik breadcrumb monitoring
WebUI.verifyElementClickable(findTestObject('Page_Result Monitoring/Monitoring Breadcrumb')) //skr test obj nya blm ada krn buttonya blm ada
WebUI.click(findTestObject('Page_Result Monitoring/Monitoring Breadcrumb'))
