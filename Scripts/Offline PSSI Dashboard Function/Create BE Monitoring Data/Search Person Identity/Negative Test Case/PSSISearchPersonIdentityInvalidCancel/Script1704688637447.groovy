...
// verify pop up nya ada dan klik cancel yg invalid (escape dan klik diluar box)
WebUI.sendKeys(findTestObject('Page_Monitoring/button_Cancel Pop Up'), Keys.chord(Keys.ESCAPE)) //klik esc

// verify pop up masih ada
WebUI.verifyTextPresent('Identify Now', false)

WebUI.clickOffset(findTestObject('Page_Monitoring/button_Cancel Pop Up'), 50, 0) //klik diluar box
