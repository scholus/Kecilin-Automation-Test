...
WebUI.setText(findTestObject('Page_Monitoring/Left search field'), 'heheheh')

// pastikan hasilnya ada empty message
...
WebUI.setText(findTestObject('Page_Monitoring/Right Search Box'), 'hehehhe')
...
WebUI.setText(findTestObject('Page_Monitoring/Bottom Search Box'), 'ehehehhe')
