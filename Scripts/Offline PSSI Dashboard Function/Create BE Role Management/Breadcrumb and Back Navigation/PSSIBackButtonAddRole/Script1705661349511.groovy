...
WebUI.navigateToUrl(baseUrl + '/roles/create')

//cari dan klik back button
WebUI.verifyElementPresent(findTestObject('Page_Add Role/Back Button'),1)
WebUI.verifyElementClickable(findTestObject('Page_Add Role/Back Button'))
WebUI.click(findTestObject('Page_Add Role/Back Button'))
