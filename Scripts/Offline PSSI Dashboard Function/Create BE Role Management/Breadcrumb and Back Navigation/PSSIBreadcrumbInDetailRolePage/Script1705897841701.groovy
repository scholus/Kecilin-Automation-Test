...
WebUI.verifyElementChecked(findTestObject('Page_Account Management Edit Role/Role Management Breadcrumb'), 0)
WebUI.click(findTestObject('Page_Account Management Edit Role/Role Management Breadcrumb'))
