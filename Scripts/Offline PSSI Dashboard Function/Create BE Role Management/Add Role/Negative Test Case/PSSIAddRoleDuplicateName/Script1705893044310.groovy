...
//isi field dengan duplicate data (nama)
//field nama yg duplicate masih hardcode, harusnya http req ke BE
WebUI.verifyElementClickable(findTestObject('Page_Add Role/Role Name Field'))
WebUI.setText(findTestObject('Page_Add Role/Role Name Field'), 'asas')
