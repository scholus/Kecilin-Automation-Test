...
WebUI.verifyElementClickable(findTestObject('Page_Role Management/Search Field'))
WebUI.setText(findTestObject('Page_Role Management/Search Field'), 'asasasasas')

//verifikasi ada search result
WebUI.verifyTextPresent('no result', false)
