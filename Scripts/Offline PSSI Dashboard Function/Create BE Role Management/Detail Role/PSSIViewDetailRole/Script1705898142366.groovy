...
WebUI.navigateToUrl(baseUrl + '/roles/detail/65ade43e12ca78ff5335c467', failureHandling)

//verifikasi sudah di page detail role
WebUI.verifyTextPresent('Detail Role', false)

//verifikasi data sesuai
//harus ambil dri BE

//verifikasi toggle ga bisa diklik
WebUI.click(findTestObject('Page_Add Role/Dashboard Index Toggle'))
WebUI.verifyElementNotPresent(findTestObject('Page_Add Role/Active Dashboard Index Toggle'), 0)
