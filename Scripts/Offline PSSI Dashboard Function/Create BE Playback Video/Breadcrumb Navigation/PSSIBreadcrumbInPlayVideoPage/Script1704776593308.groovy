...
WebUI.verifyElementClickable(findTestObject('Page_Playback Video/Breadcrumb Playback Video')) //skrg test obj blm ad
WebUI.click(findTestObject('Page_Detail User/Playback Video'))
