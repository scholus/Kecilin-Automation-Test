...
WebUI.verifyElementClickable(findTestObject('Page_Playback Video/Stadium Search Field'))

WebUI.setText(findTestObject('Page_Playback Video/Stadium Search Field'), 'Bung')

// verify keyword search ada di hasil search
String expectedPattern = '.Bung.'

String elementText = WebUI.getText(findTestObject('Page_Playback Video/Stadium Search Box'))
...
WebUI.verifyElementClickable(findTestObject('Page_Playback Video/Remove Item Stadium Selection Bar'))

WebUI.clickOffset(findTestObject('Page_Playback Video/Stadium Selection Bar'),50,50)

// verifikasi stadium udh keremove
WebUI.verifyElementText(findTestObject('Page_Playback Video/Stadium Selection Bar'), '-- Search Stadium --')
WebUI.closeBrowser()