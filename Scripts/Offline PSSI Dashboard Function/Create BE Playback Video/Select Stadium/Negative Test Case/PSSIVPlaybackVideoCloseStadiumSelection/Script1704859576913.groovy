...
WebUI.verifyElementNotPresent(findTestObject('Page_Playback Video/Stadium Search Field'),0)

// skenario 2: tutup selection dengan klik area luar
WebUI.verifyElementClickable(findTestObject('Page_Playback Video/Stadium Selection Bar')) // buka dulu
WebUI.click(findTestObject('Page_Playback Video/Stadium Selection Bar'))
WebUI.clickOffset(findTestObject('Page_Playback Video/Stadium Selection Bar'), 50, 100) // ketika udh kebuka baru klik bagian luar
