...
//mulai cari stadium dengan input yg ngaco
...
WebUI.setText(findTestObject('Page_Playback Video/Stadium Search Field'), 'Basasasasung')
WebUI.sendKeys(findTestObject('Page_Playback Video/Stadium Search Field'), Keys.chord(Keys.ENTER))

WebUI.verifyTextPresent('No results found', true)
