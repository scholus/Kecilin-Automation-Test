...
WebUI.sendKeys(findTestObject('Page_Playback Video/Stadium Search Field'), Keys.chord(Keys.ARROW_DOWN))
WebUI.sendKeys(findTestObject('Page_Playback Video/Stadium Search Field'), Keys.chord(Keys.ARROW_UP))
WebUI.sendKeys(findTestObject('Page_Playback Video/Stadium Search Field'), Keys.chord(Keys.ENTER))

//verify udh kepilih
WebUI.verifyTextNotPresent('-- Search Stadium --', false)
...
//verify udh kepilih
WebUI.verifyTextNotPresent('-- Search CCTV --', false)
