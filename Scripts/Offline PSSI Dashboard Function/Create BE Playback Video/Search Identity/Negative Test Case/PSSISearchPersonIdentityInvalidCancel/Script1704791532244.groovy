...
WebUI.sendKeys(findTestObject('Page_Playback Video/button_Cancel Pop Up'), Keys.chord(Keys.ESCAPE)) //klik esc

// verify pop up masih ada
WebUI.verifyTextPresent('Identity Now', false)

WebUI.clickOffset(findTestObject('Page_Playback Video/button_Cancel Pop Up'), 50, 0) //klik diluar box
