...
WebUI.verifyElementPresent(findTestObject('Page_Account Management Add Account/Account Management Breadcrumb'), 0, failureHandling) //skr test obj blm ada
WebUI.verifyElementChecked(findTestObject('Page_Account Management Add Account/Account Management Breadcrumb'), 0)
WebUI.click(findTestObject('Page_Account Management Add Account/Account Management Breadcrumb'))
