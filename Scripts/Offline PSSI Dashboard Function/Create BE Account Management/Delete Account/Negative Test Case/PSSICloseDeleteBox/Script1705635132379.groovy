...
WebUI.callTestCase(findTestCase('Offline PSSI Dashboard Function/Create BE Account Management/View Account Management/PSSIViewAccountManagement'), 
    [:], failureHandling)
...
WebUI.clickOffset(findTestObject('Page_Account Management/Cancel Button pop up'), 100, 100)
...
WebUI.click(findTestObject('Page_Account Management/Close Button pop up'))
