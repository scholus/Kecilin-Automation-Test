...
//konfirmasi delete
WebUI.verifyElementClickable(findTestObject('Page_Account Management/Delete Button pop up'))
WebUI.click(findTestObject('Page_Account Management/Delete Button pop up'))
...
WebUI.verifyTextNotPresent('viewer8', false)
