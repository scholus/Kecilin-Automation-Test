...
WebUI.setText(findTestObject('Page_Create Account/Name Field'), 'tes pic ngaco1')
WebUI.verifyElementClickable(findTestObject('Page_Create Account/Email Field'))
WebUI.setText(findTestObject('Page_Create Account/Email Field'), 'tespicngaco1@ngaco.com')
