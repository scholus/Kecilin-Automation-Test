...
WebUI.setText(findTestObject('Page_Create Account/Name Field'), 'tes pic ngaco10')
WebUI.verifyElementClickable(findTestObject('Page_Create Account/Email Field'))
WebUI.setText(findTestObject('Page_Create Account/Email Field'), 'tespicngaco91@ngaco.com')
...
WebUI.uploadFile(findTestObject('Page_Create Account/Image Field'), 'C:\\Users\\USER\\Downloads\\BlueStacksInstaller_5.20.0.1037_native.exe')
...
WebUI.verifyTextPresent('Invalid picture format', false)
